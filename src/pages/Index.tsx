...
const creativeProjects = [
	{
		...
		description:
			"Stunning 3D interactive portfolio website built with WebGL and React. Features particle systems, custom shaders, and smooth animations.",
	...
	},
	{
		...
		description:
			"Real-time AI-powered art generation using Stable Diffusion. Create unique artwork with natural language prompts.",
		tags: ["Python", "AI/ML", "FastAPI", "React"],
		stars: "23.5k",
		forks: "4.2k",
		gradient: "linear-gradient(135deg, #f093fb 0%, #f5576c 100%)",
		url: "https://github.com/topics/ai-art-generator?o=asc&s=stars"
	},
	{
		title: "Motion Canvas",
		description:
			"Programmatic animation library for creating educational content. Code-driven approach to video production.",
	...
	},
	{
		...
		description:
			"Interactive terminal-style portfolio with custom shell commands. Nostalgic hacker aesthetic with modern tech.",
		tags: ["Next.js", "TypeScript", "CLI"],
		stars: "8.9k",
		forks: "1.2k",
		gradient: "linear-gradient(135deg, #43e97b 0%, #38f9d7 100%)",
		url: "https://github.com/topics/terminal-based-portfolio"
		
	},
	{
		title: "Particle System",
		description:
			"Physics-based particle effects library with GPU acceleration. Create mesmerizing visual effects with ease.",
		tags: ["JavaScript", "WebGPU", "Physics"],
		stars: "19.3k",
		forks: "3.1k",
		gradient: "linear-gradient(135deg, #fa709a 0%, #fee140 100%)",
		url: "https://github.com/topics/particle-systems"
	},
	{
		title: "Code Visualizer",
		description:
			"Real-time code execution visualizer showing data structures and algorithms in action. Perfect for learning.",
		tags: ["Vue.js", "D3.js", "Education"],
		stars: "11.7k",
		forks: "2.3k",
		gradient: "linear-gradient(135deg, #30cfd0 0%, #330867 100%)",
		url : "https://github.com/topics/code-visualization"
	},
];
		...
		<div className="min-h-screen" style={{ background: "var(--gradient-hero)" }}>
			...
			<main className="container mx-auto px-4 py-20">
				<div className="max-w-4xl mx-auto text-center space-y-8">
					...
					<div className="animate-fade-in" style={{ animationDelay: "200ms" }}>
						<LoginButton className="btn-hero text-lg px-8 py-6 rounded-full" />
				...
				<div className="container mx-auto px-4 py-20 relative">
					...
					<div className="max-w-6xl mx-auto space-y-8">
						...
						<div className="text-center mt-12 animate-fade-in" style={{ animationDelay: "1200ms" }}>
							...
							<LoginButton className="btn-hero px-8 py-6 rounded-full" />
						</div>
					</div>
				</div>
			</main>
			...
			<footer className="container mx-auto px-4 py-8 text-center text-sm text-muted-foreground space-y-2">
				...
				<p className="flex items-center justify-center gap-1">
					Developed with{" "}
					<Heart className="h-4 w-4 text-red-500 fill-red-500 animate-pulse" /> by{" "}
					<span className="font-semibold text-foreground">Akash Saha</span>
				</p>
			</footer>
		</div>
	);
